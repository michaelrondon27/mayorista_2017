                ...
                <div class="panel-body">
                    <div class="col-md-9">
                        <p class="animated fadeInDown">
                          	Configuracióm <span class="fa-angle-right fa"></span> Editar Modelo <span class="fa-angle-right fa"></span> <?php echo $_modelo[$_GET['id']]['modelo'];?>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p class="animated fadeInDown">
            ...
            <div class="col-md-6 col-md-offset-2">
                <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                    	...
                    	<br>
                      	<div class="col-md-12">
                        	<form class="cmxform" id="modelo" method="post" action="?view=config&mode=editModelo&id=<?php echo $_GET['id'];?>">
                          		<div class="col-md-12">
                            		<div class="form-group form-animate-text col-md-12" style="margin-top: -10px !important;">
                              			<input type="text" class="form-text" name="modelo" id="modelo" required value="<?php echo $_modelo[$_GET['id']]['modelo'];?>">
                              			<span class="bar"></span>
                              			<label>*Modelo:</label>
                            		</div>
                            		<div class="form-group form-animate-text col-md-12" style="margin-top: -10px !important;">
                              			<input type="text" class="form-text" name="precio" id="precio" onkeypress="return solonumeros2(event)" required value="<?php echo $_modelo[$_GET['id']]['precio'];?>">
                              			<span class="bar"></span>
                              			<label>*Precio:</label>
                            		...
                            		<div class="form-group form-animate-text col-md-12" style="margin-top: -30px !important;">
                              			<input type="text" class="form-text" name="verifique" id="verifique" onkeypress="return deshabilitarteclas(event)" autocomplete="off" required value="<?php echo $precio=number_format($_modelo[$_GET['id']]['precio'], 2, ',', '.')?>">
                              			<span class="bar"></span>
	                                	...
	                                	<select name="producto" id="producto" class="form-control">
		                            		...
		                            		<?php
		                            			foreach($_producto as $producto){
		                            				if($_modelo[$_GET['id']]['id_producto']==$producto['id_producto']){
		                            					?>
	                                ...
	                                <div class="form-group form-animate-text col-md-3" style="margin-top: -10px !important;">
	          						...
	          						<div class="form-group form-animate-text col-md-9" style="margin-top:0px !important;">
	                                	<select name="cronograma" id="cronograma" class="form-control">
		                            		<?php
		                            			if($_modelo[$_GET['id']]['cronograma']==1){
		                            				?>
		                            					<option value="">Seleccione</option>
					                            		<option value="1" selected>3er Cronograma</option>
					                            		<option value="2">4to Cronograma</option>
		                            				<?php
		                            			}else if($_modelo[$_GET['id']]['cronograma']==2){
		                            				?>
		                            					<option value="">Seleccione</option>
					                            		<option value="1">3er Cronograma</option>
					                            		<option value="2" selected>4to Cronograma</option>
		                            				<?php
		                            			}
		                            		?>
		                            	</select>
