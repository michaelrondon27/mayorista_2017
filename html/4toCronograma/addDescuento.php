                ...
                <div class="panel-body">
                    <div class="col-md-10">
                        <p class="animated fadeInDown">
                          	4to Cronograma <span class="fa-angle-right fa"></span> Editar Presupuesto <span class="fa-angle-right fa"></span> <?php echo $_cotizacion4tocronograma[$_GET['id']]['cotizacion'];?> <span class="fa-angle-right fa"></span> Agregar Descuento
                        </p>
                    </div>
                    <div class="col-md-2">
                        <p class="animated fadeInDown">
			...
			<div class="col-md-10">
                <div class="col-md-10 col-md-offset-2 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                    	...
                    	<br>
                      	<div class="col-md-12">
                        	<form class="cmxform" id="addProducto" method="post" action="?view=4toCronograma&mode=addDescuento&id=<?php echo $_GET['id'];?>">
                          		<div class="col-md-12">
