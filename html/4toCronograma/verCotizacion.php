                ...
                <div class="panel-body">
                    <div class="col-md-9">
                        <p class="animated fadeInDown">
                          	4to Cronograma <span class="fa-angle-right fa"></span> Ver Presupuesto <span class="fa-angle-right fa"></span> <?php echo $_cotizacion4tocronograma[$_GET['id']]['cotizacion'];?>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p class="animated fadeInDown">
			...
			<div class="col-md-10">
                <div class="col-md-10 col-md-offset-2 panel">
                    <div class="col-md-12 panel-heading">
                      	<h4>
                      		Fecha: <?php echo $fec=date("d-m-Y", strtotime($_cotizacion4tocronograma[$_GET['id']]['fecha']));?>
                      		 <span class="fa-angle-right fa"></span> 
                      		Beneficiario: <?php echo $_beneficiario[$_cotizacion4tocronograma[$_GET['id']]['id_empresa']]['nombre'];?>
                      	</h4>
                    </div>
                    	...
                    	<br>
                      	<div class="col-md-12">
				            <table class="table table-striped table-bordered">
								...
								<?php 
									$id=$_GET['id']; 
									$sql=$db->query("SELECT o.id_ordenes, o.cantidad, o.precio_total, p.producto, m.modelo FROM ordenes_4tocronograma o INNER JOIN producto p ON o.id_producto=p.id_producto INNER JOIN modelo m ON o.id_modelo=m.id_modelo WHERE o.id_cotizacion=$id;");
									$contador=1;
									if($db->rows($sql)){
