                ...
                <div class="panel-body">
                    <div class="col-md-9">
                        <p class="animated fadeInDown">
                          4to Cronograma <span class="fa-angle-right fa"></span> Estado Cotizaciones
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p class="animated fadeInDown">
			...
			<div class="col-md-8 col-md-offset-2">
                <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                    	...
                    	<br>
                      	<div class="col-md-12">
                        	<form class="cmxform" id="estadoCotizaciones" method="post" action="?view=4toCronograma&mode=estadoCotizaciones">
                          		<div class="col-md-12">
