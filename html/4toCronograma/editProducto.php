...
<html>
	<?php
		...
		$db=new Conexion();
	?>
	<script src="asset/js/calculo4to.js"></script>
	<body>
		<div id="content">
                ...
                <div class="panel-body">
                    <div class="col-md-10">
                        <p class="animated fadeInDown">
                          	4to Cronograma <span class="fa-angle-right fa"></span> Editar Presupuesto <span class="fa-angle-right fa"></span> <?php echo $_cotizacion4tocronograma[$_GET['id']]['cotizacion'];?> <span class="fa-angle-right fa"></span> Editar Producto
                        </p>
                    </div>
                    <div class="col-md-2">
                        <p class="animated fadeInDown">
			...
			<div class="col-md-10">
                <div class="col-md-10 col-md-offset-2 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                    	...
                    	<br>
                      	<div class="col-md-12">
                        	<form class="cmxform" id="addProducto" method="post" action="?view=4toCronograma&mode=editProducto&id=<?php echo $_GET['id'];?>&orden=<?php echo $_GET['orden'];?>">
                          		<div class="col-md-12">
                          			<?php
		                       			$orden=$_GET['orden'];
										$sql=$db->query("SELECT id_almacenadora, id_producto, id_modelo, cantidad, precio_num FROM ordenes_4tocronograma WHERE id_ordenes=$orden LIMIT 1;");
