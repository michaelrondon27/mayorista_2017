	...
	<script>
		$(document).ready(function(){
			$('#productos').change(function(){
				...
				$.ajax({
			        type: "POST",
			        url: "html/3erCronograma/CantProd.php",
			        data:{
			          	"productos":producto
			        },
                ...
                <div class="panel-body">
                    <div class="col-md-9">
                        <p class="animated fadeInDown">
                          3er Cronograma <span class="fa-angle-right fa"></span> Nuevo Presupuesto
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p class="animated fadeInDown">
			...
			<div class="col-md-12">
                <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                    	...
                    	<br>
                      	<div class="col-md-12">
                        	<form class="cmxform" id="form_cotizacion" method="post" action="?view=3erCronograma&mode=addCotizacion">
                          		<div class="col-md-12">
