                ...
                <div class="panel-body">
                    <div class="col-md-9">
                        <p class="animated fadeInDown">
                          	3er Cronograma <span class="fa-angle-right fa"></span> Editar Presupuesto <span class="fa-angle-right fa"></span> <?php echo $_cotizacion3ercronograma[$_GET['id']]['cotizacion'];?>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p class="animated fadeInDown">
			...
			<div class="col-md-12">
                <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                    	...
                    	<br>
                      	<div class="col-md-12">
                        	<form class="cmxform" id="form_cotizacion" method="post" action="?view=3erCronograma&mode=editCotizacion&id=<?php echo $_GET['id'];?>">
                          		<div class="col-md-12">
                            		<div class="form-group form-animate-text col-md-3" style="margin-top: -10px !important;">
                              			<input type="text" class="form-text" id="cotizacion" name="cotizacion" required value="<?php echo $_cotizacion3ercronograma[$_GET['id']]['cotizacion'];?>">
                              			<span class="bar"></span>
                              			<label>*Cotizaci&oacute;n Nro.:</label>
                            		</div>
                            		<div class="form-group form-animate-text col-md-3" style="margin-top: -10px !important;">
			                          	<input type="text" class="form-text dateAnimate" id="fecha" name="fecha" required autocomplete="off" value="<?php echo $fec=date("d-m-Y", strtotime($_cotizacion3ercronograma[$_GET['id']]['fecha']));?>">
			                          	<span class="bar"></span>
	                                	...
	                                	<select class="form-control" name="empresa" id="empresa">
	                                		...
	                                		<?php
												foreach ($_beneficiario as $beneficiario) {
													if($beneficiario['id_empresa']==$_cotizacion3ercronograma[$_GET['id']]['id_empresa']){
														?>
            ...
            <div class="col-md-12">
                <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      	...
                      	<div class="col-md-3">
                        	<p class="animated fadeInDown">
                          		<a class="btn btn-danger" href="?view=3erCronograma&mode=addProducto&id=<?php echo $_GET['id'];?>">Agregar Producto <i class="fa fa-sign-in" aria-hidden="true"></i></a>
                        	</p>
                    	</div>
                    	<div class="col-md-3">
                        	<p class="animated fadeInDown">
                          		<a class="btn btn-danger" href="?view=3erCronograma&mode=addDescuento&id=<?php echo $_GET['id'];?>">Agregar o Editar Descuento <i class="fa fa-sign-in" aria-hidden="true"></i></a>
                        	</p>
                    	</div>
                    </div>
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      	...
                      	<div class="col-md-12">
                        	<div class="form-group">
					            <table class="table table-striped table-bordered" id="mitabla">
									...
									<?php 
										$id=$_GET['id']; 
										$sql=$db->query("SELECT o.id_ordenes, o.cantidad, o.precio_total, p.producto, m.modelo FROM ordenes_3ercronograma o INNER JOIN producto p ON o.id_producto=p.id_producto INNER JOIN modelo m ON o.id_modelo=m.id_modelo WHERE id_cotizacion=$id;");
										$contador=1;
										if($db->rows($sql)){
