	...
	<body>
		<div id="content">
                ...
                <div class="panel-body">
                    <div class="col-md-9">
                        <p class="animated fadeInDown">
                          	3er Cronograma <span class="fa-angle-right fa"></span> Editar Orden de Despacho del Presupuesto <span class="fa-angle-right fa"></span> <?php echo $_cotizacion3ercronograma[$_GET['id']]['cotizacion'];?>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p class="animated fadeInDown">
			...
			<div class="col-md-10">
                <div class="col-md-10 col-md-offset-2 panel">
                    <div class="col-md-12 panel-heading">
                      	<h4>Editar Orden de Despacho <span class="fa-angle-right fa"></span> <?php echo $_nroOrden3erCronograma[$_cotizacion3ercronograma[$_GET['id']]['id_cotizacion']]['nro_orden']?></h4>
                    </div>
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                    	<p>Los campos con (*) son obligatorios.</p>
                    	<br>
                      	<div class="col-md-12">
                        	<form class="cmxform" id="form_orden" method="post" action="?view=3erCronograma&mode=editOrden&id=<?php echo $_GET['id'];?>">
                          		<div class="col-md-12">
	                                <div class="form-group form-animate-text col-md-12" style="margin-top:-12px !important;">
	                                	<input type="text" class="form-text" id="orden" name="orden" required value="<?php echo $_nroOrden3erCronograma[$_cotizacion3ercronograma[$_GET['id']]['id_cotizacion']]['nro_orden']?>">
					                    <span class="bar"></span>
                          		...
                          		<div class="col-md-12">
	                                <div class="form-group form-animate-text col-md-12" style="margin-top:-12px !important;">
	                                	<input type="text" class="form-text" value="<?php echo $_beneficiario[$_cotizacion3ercronograma[$_GET['id']]['id_empresa']]['nombre'];?>" onkeypress="return deshabilitarteclas(event)">
					                    <span class="bar"></span>
                          		...
                          		<?php 
									...
									$sql=$db->query("SELECT pago, deposito, banco, id_despacho FROM despacho_3ercronograma WHERE id_cotizacion=$id_cotizacion");
									$contador=1;
										...
										?>
											<div class="form-group">
											    ...
											    <div class="form-group col-sm-2">
											    	<a class="btn btn-danger" onclick="DeleteItem('¿Está seguro de eliminar este pago?','?view=3erCronograma&mode=deletePago&id=<?php echo $_cotizacion3ercronograma[$_GET['id']]['id_cotizacion'];?>&id_despacho=<?php echo $data[3];?>')">Eliminar</a>
											    </div>
											</div>
											<?php
										$contador++;
            ...
            <div class="col-md-10">
                <div class="col-md-10 col-md-offset-2 panel">
                    <div class="col-md-12 panel-heading">
                      	<h4>Agregar Pago al Presupuesto <span class="fa-angle-right fa"></span> <?php echo $_cotizacion3ercronograma[$_GET['id']]['cotizacion'];?></h4>
                    </div>
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                    	<?php
							$add=5-$contador;
							if($add>0){
								?>
									<form class="form-horizontal" method="POST" action="?view=3erCronograma&mode=addPago&id=<?php echo $_GET['id'];?>">
										<div class="form-group">
					                       	<div class="col-sm-1">
