<?php
	...
	$evento="Reporte de la cotizacion del 3er cornograma en excel: ".$id_cotizacion;
	...
	$archivo="Listado De Productos de la Cotizacion ".$_cotizacion3er[$id_cotizacion]['cotizacion'].".xls";
