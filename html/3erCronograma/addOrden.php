                ...
                <div class="panel-body">
                    <div class="col-md-9">
                        <p class="animated fadeInDown">
                          	3er Cronograma <span class="fa-angle-right fa"></span> Generar Orden de Despacho del Presupuesto <span class="fa-angle-right fa"></span> <?php echo $_cotizacion3ercronograma[$_GET['id']]['cotizacion'];?>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p class="animated fadeInDown">
			...
			<div class="col-md-10">
                <div class="col-md-10 col-md-offset-2 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                    	...
                    	<br>
                      	<div class="col-md-12">
                        	<form class="cmxform" method="post" action="?view=3erCronograma&mode=addOrden&id=<?php echo $_GET['id'];?>" id="form_orden">
                          		<div class="col-md-12">
